...
public class Main_Q5 {
    public static void main(String[] args) {
        ...
        //Declare fmt as a DecimalFormat object and instantiate it to format numbers with at least one digit
        //to the left of the decimal and the fractional part rounded to two digits.
